...
const customerSeedData = [
    {
        ...
        boys: 1,
        girls: 1,
        bank_details: 'Chase Bank - Account ending in 1234',
        profile_pic: 'https://t3.ftcdn.net/jpg/07/24/59/76/360_F_724597608_pmo5BsVumFcFyHJKlASG2Y2KpkkfiYUU.jpg',
        status: 'active',
    ...
    },
    {
        ...
        boys: 0,
        girls: 0,
        bank_details: 'Bank of America - Account ending in 5678',
        profile_pic: 'https://t3.ftcdn.net/jpg/07/24/59/76/360_F_724597608_pmo5BsVumFcFyHJKlASG2Y2KpkkfiYUU.jpg',
        status: 'active',
    ...
    },
    {
        ...
        boys: 1,
        girls: 0,
        bank_details: 'Wells Fargo - Account ending in 9012',
        profile_pic: 'https://t3.ftcdn.net/jpg/07/24/59/76/360_F_724597608_pmo5BsVumFcFyHJKlASG2Y2KpkkfiYUU.jpg',
        status: 'inactive',
    ...
    },
    {
        ...
        boys: 2,
        girls: 1,
        bank_details: 'SunTrust Bank - Account ending in 3456',
        profile_pic: 'https://t3.ftcdn.net/jpg/07/24/59/76/360_F_724597608_pmo5BsVumFcFyHJKlASG2Y2KpkkfiYUU.jpg',
        status: 'active',
    ...
    },
    {
        ...
        boys: 2,
        girls: 2,
        bank_details: 'Chase Bank - Account ending in 7890',
        profile_pic: 'https://t3.ftcdn.net/jpg/07/24/59/76/360_F_724597608_pmo5BsVumFcFyHJKlASG2Y2KpkkfiYUU.jpg',
        status: 'active',
    ...
    },
    {
        ...
        boys: 0,
        girls: 0,
        bank_details: 'US Bank - Account ending in 2468',
        profile_pic: 'https://t3.ftcdn.net/jpg/07/24/59/76/360_F_724597608_pmo5BsVumFcFyHJKlASG2Y2KpkkfiYUU.jpg',
        status: 'active',
    ...
    },
    {
        ...
        boys: 1,
        girls: 1,
        bank_details: 'Credit Union - Account ending in 1357',
        profile_pic: 'https://t3.ftcdn.net/jpg/07/24/59/76/360_F_724597608_pmo5BsVumFcFyHJKlASG2Y2KpkkfiYUU.jpg',
        status: 'active',
    ...
    },
    {
        ...
        boys: 0,
        girls: 1,
        bank_details: 'First National Bank - Account ending in 8024',
        profile_pic: 'https://t3.ftcdn.net/jpg/07/24/59/76/360_F_724597608_pmo5BsVumFcFyHJKlASG2Y2KpkkfiYUU.jpg',
        status: 'active',
...
const seedUsers = async () => {
    try {
        ...
        // Insert dummy users
        const result = await User.insertMany(userSeedData);
...
const seedCustomers = async () => {
    try {
        ...
        const result = await Customer.insertMany(customerSeedData);
