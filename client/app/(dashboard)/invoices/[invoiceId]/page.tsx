...
import { capitalize, formatDate } from '@/lib/utility/functions';
                    ...
                    <div className="flex flex-col justify-between gap-6 sm:flex-row lg:w-2/3">
                        ...
                        <div className="xl:1/3 sm:w-1/2 lg:w-2/5">
                            <div className="mb-2 flex w-full items-center justify-between">
                                ...
                                <div className="whitespace-nowrap">{capitalize(invoice?.result?.payment_type)}</div>
                            </div>
                            <div className="mb-2 flex w-full items-center justify-between">
                            ...
                            {invoice?.result?.invoice_items?.map((item: InvoiceItem, i: number) => {
                                return (
                                    <tr key={i}>
                                        ...
                                        <td className="ltr:text-right rtl:text-left">${item.discount}</td>
