import { MessageNoDataAvaibleIcon, MessagesCloseIcon, MessagesIcon, NotificationCongratulationsIcon, NotificationInfo, NotificationSomeThingWrong, NotificationWarning, ViewAllActivityIcon } from '@/icons';
