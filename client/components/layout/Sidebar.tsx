...
import { ContactIcon, DoubleArrowIcon, FaqIcon, InvoiceIcon, MailBox, NotesIcon, ProductIcon, TicketIcon, TodoIcon } from "@/icons"
import { useAppDispatch, useAppSelector } from '@/lib/hooks';
import AnimateHeight from 'react-animate-height';
import { selectThemeConfig, toggleSidebar } from '@/lib/features/theme/themeSlice';
import { LeadsIcon } from '@/icons/sidebarIcons/LeadsIcon';
                ...
                <div className="h-full bg-white dark:bg-black">
                    ...
                    <div className="flex items-center justify-between px-2 py-3 overflow-hidden">
                        <Link href="/" className="flex shrink-0 items-center">
                            <Image className="flex-none" src="/assets/images/logo.png" alt="logo" width={60} height={80} />
                                ...
                                <ul>
                                    <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'leads' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('leads')}>
                                            <div className="flex items-center">
                                                <LeadsIcon />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-white dark:group-hover:text-primary-light ">Lead Management</span>
                                            </div>
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'leads' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                ...
                                                <li>
                                                    <Link href="/leads/dashboard">Leads Dashboard</Link>
                                                </li>
                                                <li>
                                                    <Link href="#">Create Lead</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                                    ...
                                    <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'kyc' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('kyc')}>
                                            <div className="flex items-center">
                                                <ContactIcon />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-white dark:group-hover:text-primary-light ">KYC</span>
                                            </div>

                                            <div className={currentMenu === 'kyc' ? 'rotate-90' : 'rtl:rotate-180'}>
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M9 5L15 12L9 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                </svg>
                                            </div>
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'kyc' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/kyc">Individuals</Link>
                                                </li>
                                                <li>
                                                    <Link href="/coparate">Coparates</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
