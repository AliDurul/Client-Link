...
export const themeSlice = createAppSlice({
    ...
    reducers: (create) => ({
        ...
        toggleSemidark: create.reducer((state, action: PayloadAction<boolean | string>) => {
            ...
            // @ts-expect-error: localStorage.setItem expects a string, but action.payload may be boolean
...
export const { toggleTheme, toggleMenu, toggleLayout, toggleRTL, toggleAnimation, toggleNavbar, toggleSemidark, toggleSidebar, setPageTitle } = themeSlice.actions;


export const { selectThemeConfig, selectIsDarkMode, selectRtlClass, selectSidebar } = themeSlice.selectors;
