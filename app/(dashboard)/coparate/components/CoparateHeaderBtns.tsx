'use client'
import { selectCoparateValue, setValue, updateCoparateState } from '@/lib/features/coparate/coparateSlice';
import { useAppDispatch, useAppSelector } from '@/lib/hooks';
import { useRouter } from 'next/navigation';
import React from 'react'

const CoparateHeaderBtns = () => {
    ...
    return (
        <>
            <div>
                <button type="button" className="btn btn-primary" onClick={() => { router.push(`/coparate/action?s=e`), dispatch(updateCoparateState(null)) }}>
...
export default CoparateHeaderBtns