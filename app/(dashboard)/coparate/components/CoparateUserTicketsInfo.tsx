...
interface CoparateUserTicketsInfoProps {
    userTickets: Ticket[];
    summaryArray: { title: string, value: number, customStyle: string }[];
}

const CoparateUserTicketsInfo = ({ userTickets, summaryArray }: CoparateUserTicketsInfoProps) => {
    return (
...
export default CoparateUserTicketsInfo